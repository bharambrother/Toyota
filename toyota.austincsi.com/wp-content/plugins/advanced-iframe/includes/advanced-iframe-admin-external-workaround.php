...
<div>
    ...
    <p><?php _e('The external workaround does enable many features which are not possible directly because of cross domain security restrictions. You need to include a Javascript file (ai_exernal.js) to the page in the iframe which is generated dynamically with your settings. <strong>If you mix http and https pages you NEED to enable "Use post message for communication"!</strong> Please follow the instructions below. In the advanced tab are many settings marked with ', 'advanced-iframe');
...
<?php } ?>
    ...
    _e('
    <h3 id="mirp">How to configure the workaround file ai_external.js to work with different settings</h3>
    <p>
