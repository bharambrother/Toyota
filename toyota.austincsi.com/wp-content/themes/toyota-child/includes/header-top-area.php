					...
					<?php 
						if( ( mfn_header_style( true ) != 'header-overlay' ) && ( mfn_opts_get( 'menu-style' ) != 'hide' ) ){
							...
							echo '<a class="responsive-menu-toggle '. $mb_class .'" href="#">';
								echo '<svg xml:space="preserve" style="enable-background:new 425.434 735.669 15.67 15.394;" viewBox="425.434 735.669 15.67 15.394" y="0px" x="0px" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" version="1.1" class="tcom-icon mobile-nav-icon"><style type="text/css">.st0{fill:#010101;}</style><g><rect height="1" width="15.67" class="st0" y="735.669" x="425.434"></rect><rect height="1" width="15.67" class="st0" y="742.867" x="425.434"></rect><rect height="1" width="15.67" class="st0" y="750.064" x="425.434"></rect></g></svg>';
								$menu_text = mfn_opts_get( 'header-menu-text' );
